...
def _json_safe(value: Any):
    """Convert component payloads to strict JSON-compatible values.

    Streamlit's browser component ultimately parses JSON, where NaN and ±Infinity
    are invalid tokens. Review/resume rows can legitimately contain missing numeric
    metadata, so normalize those values to null before crossing the Python→browser
    boundary.
    """
